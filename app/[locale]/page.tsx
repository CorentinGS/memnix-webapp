...
export default function Home() {
    ...
    return (
        <main>
            <section
                className="max-w-6xl mx-auto px-4 sm:px-6 md:flex md:h-screen 2xl:h-auto pt-[72px] md:min-h-[calc(100vh-72px)]">
                    ...
                    <div className="pb-12 md:pb-0 md:py-0 mx-auto md:pr-16 flex items-center basis-3/5">
                      ...
                      {chunks}
                            ...
                            <div className="max-w-3xl mx-auto">
                                <div
                                    className="max-w-xs sm:max-w-md flex flex-nowrap flex-col sm:flex-row gap-4 m-auto md:m-0 justify-center md:justify-start">
