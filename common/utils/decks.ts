...
export async function getOwnedDeck(token: string): Promise<ApiResponse<IDeckList>> {
...
export async function getLearningDeck(token: string): Promise<ApiResponse<IDeckList>> {
