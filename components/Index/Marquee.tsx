export default function Marquee() {
    ...
    return (
        <>
            <div
                className="p-x-4 relative mx-auto flex w-[50%] max-w-[90%] flex-shrink-0 flex-col gap-y-4 overflow-hidden">
                ...
                <div
                    className="pointer-events-none absolute inset-0 bg-gradient-to-r from-base-100 via-transparent to-base-100 "/>
            </div>
        </>
    )
}
